...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s amarucoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  amarucoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded amarucoin transaction") + "\n" +
              "  amarucoin-tx [options] -create [commands]   " + _("Create hex-encoded amarucoin transaction") + "\n" +
              "\n";
