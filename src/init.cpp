...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/amarucoin-project/amarucoin>";
    const std::string URL_WEBSITE = "<https://amarucoin.org>";
