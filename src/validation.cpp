...
#if defined(NDEBUG)
# error "Amarucoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Amarucoin Signed Message:\n";
...
bool CVerifyDB::VerifyDB(const CChainParams& chainparams, CCoinsView *coinsview, int nCheckLevel, int nCheckDepth)
{
    ...
    if (nCheckDepth <= 0)
        // Amarucoin: suffices until year 10214. Didn't x4 value due to integer wrap around and upstream compatibility.
